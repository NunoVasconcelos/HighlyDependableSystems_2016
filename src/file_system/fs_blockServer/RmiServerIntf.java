...
public interface RmiServerIntf extends Remote {
    ...
    String put_k(PublicKeyBlock data, byte[] signature, RSAPublicKeyImpl public_key) throws RemoteException, NoSuchAlgorithmException, IntegrityViolationException;
